                        ...
                        for k = 0:floor((int_total_channel_number-int_su2_reserved_channels)/int_su2_min_bandwidth)
                            if((i*int_pu_bandwidth)+(j*int_su1_bandwidth)+(k*int_su2_min_bandwidth) <= int_total_channel_number)
                                  ...
                                  if(i > 0)
                                      if(k > 0)
                                          if (int_pu_bandwidth == int_su2_min_bandwidth)
                                              for z_apost = 0:ceil(int_pu_bandwidth/int_su2_min_bandwidth)
                                                  if (ceil((z_apost*int_su2_min_bandwidth)/int_pu_bandwidth) == 1) 
                               ...
                               if (int_pu_bandwidth > free)
                                      if(i > 0)
                                          if(k == 0)
                                              if (int_pu_bandwidth == int_su2_min_bandwidth && int_pu_bandwidth == int_su1_bandwidth)
                                                  for y_apost = 0:floor((int_total_channel_number - (i_apost*int_pu_bandwidth))/int_su1_bandwidth)
                                                      for z_apost = 0:floor((int_total_channel_number - (i_apost*int_pu_bandwidth) - (j_apost*int_su1_bandwidth)/int_su2_min_bandwidth))
                                                          if (ceil(((y_apost*int_su1_bandwidth) + (z_apost*int_su2_min_bandwidth))/int_pu_bandwidth) == 1)
                                    ...
                                    if(int_su1_bandwidth + int_su1_reserved_channels <= int_total_channel_number - (i_apost*int_pu_bandwidth) - (j_apost*int_su1_bandwidth))
                                          if (int_su1_bandwidth > free)
                                             if (int_su1_bandwidth == int_su2_min_bandwidth)
                                                  for z_apost = 0:ceil(int_su1_bandwidth/int_su2_min_bandwidth)
                                                     if (ceil((z_apost*int_su2_min_bandwidth)/int_su1_bandwidth) == 1)
